...
from app.api.v1.entity_dynamics import router as entity_dynamics_router
...
router.include_router(market_regime_router, prefix="/market-regime", tags=["market-regime"])
router.include_router(strategy_lab_router, prefix="/strategy-lab", tags=["strategy-lab"])
router.include_router(entity_dynamics_router, prefix="/entity-dynamics", tags=["entity-dynamics"])
